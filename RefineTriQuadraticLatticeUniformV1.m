function [ControlpointsNew,LatticeNew,LatticeVolume,LatticeFaces,LatticeEdges,LatticeVertices,IsInnerVertex,ValenceInnerVertex] = RefineTriQuadraticLatticeUniformV1(Controlpoints,Lattice,mu)
%REFINETRIQUADRATICLATTICEUNIFORMV1 refines a given lattice of control points 
% Controlpoints and volumes Lattice into a finer lattice using the 
% variant V1 of the tri quadratic subdivison algorithm.
%
...
%       reshape(P(:,i),[n,n])
%       The value of the subdominant eigenvalue: mu
%
...
for i=1:AmountOfVolumes
    ...
    SubdivisionMatrixSmall=computeTriQuadraticSubdivisionMatrixV1(PSmall,mu);
