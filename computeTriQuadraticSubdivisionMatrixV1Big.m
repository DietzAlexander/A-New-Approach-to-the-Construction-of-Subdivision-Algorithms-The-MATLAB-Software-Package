function [S,Lattice] = computeTriQuadraticSubdivisionMatrixV1Big(Input,mu,varargin)
%COMPUTETRUQUADRATICSUBDIVISIONMATRIXV1BIG computes out of a polytope structure the
...
SCenter=computeTriQuadraticSubdivisionMatrixV1(FaceMatrix,mu,vararginSmallCentral{:});
...
for i=1:AmountOfFaces
    ...
    if seen(n)==0
        ...
        M=computeTriQuadraticSubdivisionMatrixV1(PrismaPolygon,mu,'PreventInputCheck');
...
MTrap3=computeTriQuadraticSubdivisionMatrixV1(MAdjacencyTrap3,mu,'PreventInputCheck');
...
for i=1:AmountOfBlocks
    ...
    %if not, compute the necessary subdivision matrix
        ...
        M=computeTriQuadraticSubdivisionMatrixV1(MAdjacency,mu,'PreventInputCheck');
    end
...
%Also a local function in computeTriQuadraticSubdivisionMatrixV2Big
