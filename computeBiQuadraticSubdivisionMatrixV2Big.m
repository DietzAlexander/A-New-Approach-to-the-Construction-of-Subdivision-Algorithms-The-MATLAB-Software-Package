function [ S ] = computeBiQuadraticSubdivisionMatrixV2Big( n )
%computeBiQuadraticSubdivisionMatrixV2Big computes the subdivision matrix
%for the quadratic 2-D case with the size of a ring after the second variant.
%
% Input:  n: Amount of points of the central 2-polytope
% Output: S: 9n x 9n subdivision matrix
%
%computeBiQuadraticSubdivisionMatrixV2Big(n) computes the subdivision matrix for 
% the cubic 2-D case with the size of a ring.
    ...
    SCenter=computeBiQuadraticSubdivisionMatrixV2(n);
